...
if __name__ == '__main__':
    ...
    for interval in intervals:
        ...
        if sections2[0] <= sections1[0] <= sections2[1]:
            pairs += 1
        elif sections1[0] <= sections2[0] <= sections1[1]:
            pairs += 1
        elif sections2[0] <= sections1[1] <= sections2[1]:
            pairs += 1
        elif sections1[0] <= sections2[1] <= sections1[1]:
            pairs += 1
    print(pairs)
